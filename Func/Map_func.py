...
def draw_land(self):
    self.image.draw(self.x + self.p.efx, self.y + self.p.efy - (self.p.y - 250) / 2, 4096, 512)


def draw_wall(self):
    self.image.draw(self.x1 + self.p.efx, self.y + self.p.efy - (self.p.y - 250) / 2, 1280, 1920)
    self.image.draw(self.x2 + self.p.efx, self.y + self.p.efy - (self.p.y - 250) / 2, 1280, 1920)


def draw_background(self):
    self.image_back.draw(WIDTH / 2, HEIGHT / 2, WIDTH, HEIGHT)
    self.image.draw(self.x + self.p.efx, self.y + self.p.efy - (self.p.y - 250) / 2, 4096, 1100)
